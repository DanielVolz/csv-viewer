...
class TestCsvUtils:
    ...
    def test_read_csv_file(self):
        ...
        csv_data = 'IP Address,Line Number,Serial Number,Model Name,MAC Address,MAC Address 2,Subnet Mask,Voice VLAN,Speed 1,Speed 2,Switch Hostname,Switch Port,Speed Switch-Port,Speed PC-Port\n' \
    ...
    def test_read_csv_file_with_real_data(self):
        ...
        csv_data = 'IP Address,Line Number,Serial Number,Model Name,KEM,KEM 2,MAC Address,MAC Address 2,Subnet Mask,Voice VLAN,Speed 1,Speed 2,Switch Hostname,Switch Port,Speed Switch-Port,Speed PC-Port\n' \
